...
function RegisterPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RegisterPage.useEffect": ()=>{
            if (!isUserLoading && user) {
                ...
                if (!user.emailVerified && user.providerData.some({
                    "RegisterPage.useEffect": (p)=>p.providerId === 'password'
                }["RegisterPage.useEffect"])) {
    ...
    async function onSubmit(values) {
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$non$2d$blocking$2d$login$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initiateEmailSignUp"])(auth, values.email, values.password, values.firstName, values.lastName);
        // On successful signup, Firebase automatically logs the user in.
        // The useEffect will then handle the redirection.
        } catch (error) {
            console.error("Registration failed", error);
        // The error will be displayed via toast in non-blocking-login
        }
    }
    if (isUserLoading) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    // If user is already logged in and verified, don't show the form.
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "flex items-center justify-center min-h-[calc(100vh-14rem)] py-12",
...
_s(RegisterPage, "NJ1mIn6gUYb5HKWx6CCPxm6MK3s=", false, function() {
    return [
...
//# sourceMappingURL=src_a4b5d2b1._.js.map